...
<sub>
<?php echo 'Posted on '.date('F j, Y \a\t H:i:s A', strtotime($date)).' by <a href="'.BASE_URL.'members/view/'.$uID.'">'.$first_name.' '.$last_name.'</a> in <a href="'.BASE_URL.'blog/category/'.$categoryID.'">'.$name.'</a><br>'; ?>
</sub><br>
<?php
   if($comment_count > 1)
   {
